    ...
    <div className="product-card">
      <div className="product-header">
        <div className="product-info">
          ...
          {!product.productName && !product.model_name && (
      ...
      <div className="product-details">
        ...
        {product.batch_no && (
          <span className="detail-badge">📋 Batch: {product.batch_no}</span>
        )}
        {product.channel && (
          <span className="detail-badge">📱 Channel: {product.channel}</span>
        )}
        {product.agent_id !== undefined && product.agent_id !== '' && (
          <span className="detail-badge">👤 Agent: {product.agent_id}</span>
        )}
